...
answer = "Os números não são iguais porque há amostras que não tem o sexo definido."
...
mean_trip = 0.
median_trip = 0.
length_trip_duration_list = len(trip_duration_list)
...
median_trip = sorted_trip_duration_list[int(length_trip_duration_list/2)]
